...
import 'reservable_spot.dart';

class ActiveReservtionModel extends Equatable {
	final int? id;
	...
	factory ActiveReservtionModel.fromJson(Map<String, dynamic> json) {
		return ActiveReservtionModel(
			id: json['id'] as int?,
			...
			reservableSpot: json['reservable_spot'] == null
						? null
						: ReservableSpot.fromJson(json['reservable_spot'] as Map<String, dynamic>),
		);
	}
