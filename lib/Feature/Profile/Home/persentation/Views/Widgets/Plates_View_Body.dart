                    ...
                    child: Column(
                      ...
                      children: [
                        MultiBlocProvider(
                          providers: [
                            BlocProvider(
                              create: (context) => PostGetLicensePlateCubit(
                                  profileHomeRepoImpl(ApiClass(Dio()))),
                            ),
                            BlocProvider(
                              create: (context) => PostAddLicensePlateCubit(
                                  profileHomeRepoImpl(ApiClass(Dio()))),
                            ),
                          ],
                          child: Center(
                            child: CustomAddplatepart(
                              token: token,
                              onPlateAdded: () {
                                // هنا هيتم استدعاء refresh للبيانات
                                context
                          ...
                          return AnimatedBuilder(
                            ...
                            builder: (context, child) {
                              ...
                              if (scrollController.hasClients) {
                                offset = scrollController.offset / 200 - index;
                              }
